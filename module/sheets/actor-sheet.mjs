 ...
 * @extends {ActorSheet}
 */
export class SinlessActorSheet extends ActorSheet {
  /** @override */
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ['sinless-foundry-system', 'sheet', 'actor'],
      width: 600,
      height: 600,
      tabs: [
        {
  ...
  /** @override */
  get template() {
    return `systems/sinless-foundry-system/templates/actor/actor-${this.actor.type}-sheet.hbs`
  }
  ...
  _onRoll(event) {
    ...
    if (dataset.roll) {
      let label = dataset.label ? `[pool] ${dataset.label}` : ''
