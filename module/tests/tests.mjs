    ...
    (context) => {
      ...
      describe("level 0", function () {
        ...
        describe("level 1 B", function () {
          // it("times out", async function (this) {
          //   this.timeout(200);
...
function registerPropertyTestBatch(quench) {
  quench.registerBatch(
    ...
    (context) => {
      ...
      const contains = (text, pattern) => text.includes(pattern);
...
function registerPromiseTestBatch(quench) {
  quench.registerBatch(
...
// let registerNonQuenchTestBatch = (_quench) => undefined;
// if (import.meta.env.DEV) {
//   registerNonQuenchTestBatch = (quench) => {
//     quench.registerBatch(
